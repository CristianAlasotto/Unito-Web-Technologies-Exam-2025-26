...
All endpoints support page-based and limit/offset pagination (default ten results) and a \texttt{sort} parameter (comma-separated, \texttt{-} for descending); NULL values are last. Swagger documents endpoints at \url{http://localhost:8080/swagger-ui/index.html}, and Javadoc documents all classes and methods.
